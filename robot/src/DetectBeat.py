"""
Only manually run this script when necessary.
Usage: beat_tracker.py [-h] input_file.mp3 output_beats.csv 
https://github.com/librosa/librosa/blob/master/examples/beat_tracker.py

For using new musics, user should upload the music file to robot and 
specific the path of it in Util.py. And using this script to export the 
beats file to "beats" folder and specific the new path in Util.py 
"""
